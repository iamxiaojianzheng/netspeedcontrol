...
if [ -n "$RAW_DOWNLOAD_URL" ]; then
    ...
    DOWNLOAD_URL="${PROXY}https://github.com/iamxiaojianzheng/netspeedcontrol/releases/download/v0.2.3-30/luci-app-netspeedcontrol_0.2.3-30_all.ipk"
fi
